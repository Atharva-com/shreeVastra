...
const Navbar = ({ logout, user, cart, addToCart, removeFromCart, clearCart, subTotal }) => {
    ...
    const ref = useRef()
    return (
        <div className={`mx-auto fixed top-0 z-50 flex flex-wrap pt-4 md:p-5 flex-row sm:justify-between w-full items-center justify-center shadow-sm bg-gray-800 shadow-slate-50 ${navbar ? '' : 'hidden'}`}>
            ...
            <Link href={'/'} className="flex order-first lg:order-none title-font items-center text-red-200 text-2xl font-bold justify-center mb-4 md:mb-0">
                <FaTshirt className='text-red-200 text-3xl font-sans mr-2 font-bold'/> SHREEVASTRA.COM 
            </Link>

            <form className='w-[40%] hidden lg:inline-block'>
                <div className="flex">
